...
chmod +x "/home/vagrant/installation/scripts/install-worker.sh"
/home/vagrant/installation/scripts/install-worker.sh
EOF

sudo -u "$(logname)" ssh -o "StrictHostKeyChecking no" vagrant@worker-2 << EOF
chmod +x "/home/vagrant/installation/scripts/install-worker.sh"
/home/vagrant/installation/scripts/install-worker.sh
EOF
