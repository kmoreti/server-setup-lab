...
sudo -u "$(logname)" curl -fsSL "https://storage.googleapis.com/kubernetes-release/release/v1.13.0/bin/linux/amd64/kube-apiserver" -o "$KUBE_API_SERVER"
sudo -u "$(logname)" curl -fsSL "https://storage.googleapis.com/kubernetes-release/release/v1.13.0/bin/linux/amd64/kube-controller-manager" -o "$KUBE_CONTROLLER_MANAGER"
sudo -u "$(logname)" curl -fsSL "https://storage.googleapis.com/kubernetes-release/release/v1.13.0/bin/linux/amd64/kube-scheduler" -o "$KUBE_SCHEDULER"
sudo -u "$(logname)" curl -fsSL "https://storage.googleapis.com/kubernetes-release/release/v1.13.0/bin/linux/amd64/kubectl" -o "$KUBE_CTL"
